...
| 登录计时与排序 | 本工具下一次成功退出已登录账号时开始计时；72 小时内显示“距上次登录 N 小时”，之后显示上次登录日期；登录过的账号按最近成功登录时间排在前面 |
...
| 云更新提醒 | 启动时后台检查 GitHub Latest Release；发现新版本会显示下载按钮并打开 Release 页面，**不会静默下载或替换 EXE** |
